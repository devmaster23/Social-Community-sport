...
class BloggersController extends AppController
{
    ...
    /**
     * video_uploader_share_video method
     *
     * @return void
     */
    public function video_uploader_share_video()
    {
        $this->set('title_for_layout', __('Share Video'));
        $this->loadModel('Team');
        $this->loadModel('Wall');
