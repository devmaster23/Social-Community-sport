...
<section class="content-header">
  <h1>
    ...
    <small><?php echo __dbt('<b>Allow Users to access the selected locations</b>'); ?></small>
  </h1>
	...
	<tr>
			...
			foreach($Section as $memcat){
			    ...
			    echo "<tr>
					...
					<td>
						<input type='checkbox' name='data[Section][section_list_id][]' id='SectionSectionListID' value='".$memcat['UserSection']['id']."'>
					</td>            
				</tr>";
			}
		    }else{
			...
			<div class="row">
				<div class="col-sm-5">
					<div class="dataTables_info" id="example2_info" role="status" aria-live="polite">                                   <?php echo $this->Form->submit('Allow',array('class'=>'button'));?>
					</div>
				</div>
				<div class="col-sm-7">
