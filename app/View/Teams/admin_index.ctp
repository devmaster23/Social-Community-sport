			...
			<table class="table table-striped">
				...
				<?php if(!empty($teams)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <?php echo $this->Html->link($team['Sport']['name'], array('controller' => 'sports', 'action' => 'view', base64_encode($team['Sport']['id']))); ?>
                                            </td>
                                            <td>
                                                    <?php echo $this->Html->link($team['League']['name'], array('controller' => 'leagues', 'action' => 'view', base64_encode($team['League']['id']))); ?>
                                            </td>
                                            <td>
							...
							<?php echo $this->Html->link(__dbt(''), array('action' => 'edit', base64_encode($team['Team']['id']),base64_encode($team['User']['id'])),array('class'=>'fa fa-edit','title'=>'Edit Team')); ?>
