            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <?php echo $this->Form->input('sport_id', array('class' => 'form-control', 'label' => false, "onchange" => "getTournaments(this);", 'disabled' => true)); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="inputEmail3"><?php echo __dbt('Tournament'); ?></label>
                        <div class="col-sm-4" id="tournament-box">
                            <?php echo $this->Form->input('tournament_id', array('class' => 'form-control', 'label' => false, "onchange" => "getLeagues(this);", 'disabled' => true)); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4" id="league-box">
                            ...
                            <?php echo $this->Form->input('league_id', array('type'=>'hidden')); ?>
                        </div>
                    </div>
                    <div class="form-group">
