				...
				<table class="table table-striped">
					<tbody>
						<tr>
						  ...
						  <td><?php echo $this->Form->input('name',array('class'=>'form-control','placeholder'=>__dbt('Enter your name'),'label' => false)); ?></td>
						</tr>
                                                <tr>
						...
						<tr>
						  ...
						  <td><?php echo AuthComponent::user("email") ?></td>
                                ...
                                <div class="box-footer">
                                    ...
                                    <?php
                                    echo $this->Form->button(__dbt('Cancel'), array('type' => 'reset','class'=>'btn btn-primary btn-flat btn-warning margin'));
