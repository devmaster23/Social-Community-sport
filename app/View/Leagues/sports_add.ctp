				...
				<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4" id="tournament-box">
								<?php echo $this->Form->input('tournament_id', array("class"=>"form-control",'label' => false, "empty"=>__dbt("Please Select")));  ?>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4" id="tournament-box">
								<?php $status_options = $status_options = array(__dbt("Inactive"), __dbt("Active"));
