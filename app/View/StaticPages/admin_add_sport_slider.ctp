...
<section class="content-header">
	<h1><?php echo __dbt('Add Sport Slider'); ?>
	  <small><?php echo __dbt('Admin Add Sport Slider'); ?></small>
	</h1>
	  ...
	  <div class="col-md-12">
		<div class="box box-primary">
				...
				<?php echo $this->Form->create('Slider',array('class'=>'form-horizontal', 'autocomplete'=>"off", "enctype"=>"multipart/form-data")); ?>
						...
						<div class="col-sm-4">
						<?php
						echo $this->Form->input('foreign_key', array("type"=>"select", "options"=>$sports,"class"=>"form-control",'label' => false,'empty'=>__dbt('-- Select Sport --'))); ?>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						<?php $status_options = array('1'=>__dbt("Active"),'0'=>__dbt("Inactive"));
