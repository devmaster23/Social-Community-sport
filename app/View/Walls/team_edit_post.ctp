	  ...
	  <div class="col-md-12">
		<div class="box box-primary">
				...
				<?php echo $this->Form->create('WallContent',array('class'=>'form-horizontal', 'autocomplete'=>"off", "enctype"=>"multipart/form-data"));
                                ...
                                ?>
                                    <?php echo $this->Form->hidden('update_file_id',array("value"=>$this->request->data['WallContent']['file_id'])); ?>
						...
						<?php echo $this->Wall->showPostUpload($this->request->data['WallContent']['file_id'],$this->request->data['WallContent']['content_type']); ?>
						</div>
					</div>
                                        <div class="form-group">
