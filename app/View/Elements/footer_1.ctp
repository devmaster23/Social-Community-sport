                            ...
                            <div class="row">
                                <div class="col-xs-7 form-layout">
                                    ...
                                    <fieldset> 
                                        ...
                                        <div class="spacing">
                                            <p><input type="checkbox" id="test9" class="form-control" name="data[User][remember_me]" <?php if (!empty($_COOKIE['email'])) { ?>checked="checked"<?php } ?>><label for="test9"><?php echo __dbt('Remember Me'); ?></label> </p>
                            ...
                            <div class="row">
                                <div class="col-xs-7 form-layout">
                                    ...
                                    <fieldset> 
                                        ...
                                        <div class="spacing">
                                            <p><input type="checkbox" id="test10" class="form-control" name="data[User][remember_me]" <?php if (!empty($_COOKIE['email'])) { ?>checked="checked"<?php } ?>><label for="test10"><?php echo __dbt('Remember Me'); ?></label> </p>
                                            <a href="/users/forgot_password"><small> <?php echo __dbt('Forgot Password?'); ?></small></a>            
                                        </div>  
                        ...
                        <div class="row">
                            <div class="col-xs-7 form-layout">
                                ...
                                <fieldset> 
                                    ...
                                    <div class="spacing">
                                        <p><input type="checkbox" id="test11" class="form-control" name="data[User][remember_me]" <?php if (!empty($_COOKIE['email'])) { ?>checked="checked"<?php } ?>><label for="test11"><?php echo __dbt('Remember Me'); ?></label> </p>
                                        <a href="/users/forgot_password"><small><?php echo __dbt('Forgot Password?'); ?></small></a>            
                                    </div>            
                                    <button class="btn btn-info btn-sm pull-right" name="Sign In" id="SignIn"><?php echo __dbt('SIGN IN'); ?></button>
                                </fieldset>
