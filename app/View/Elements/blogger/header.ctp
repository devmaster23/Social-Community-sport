...
if(isset($authCompponent['id']) && !empty($authCompponent['id']) && ($this->params['prefix'] == 'blogger' || $this->params['prefix'] == 'Blogger')) { ?>
<!-- HEADER -->
                ...
                <div class="right-frame">
                    <div class="header-space pull-left">
                        <div class="icon-frame position-rel">
                            <div class="icon-frame">
                                <!--a href="<?php //echo VIDEOUPLOADER_URL.'/dashboard/'?>" title="<!--?php echo __dbt('Dashboard');?>"><i class="fa fa-home"></i></a-->
                                <a href= "<?php echo  Router::fullbaseUrl().'/videoUploader/dashboard/index'?>"
                                       title="<?php echo __dbt('Dashboard');?>"><i class="fa fa-home"></i></a>
                    ...
                    <div class="orange-icon dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li><?php  echo $this->Html->link(__dbt('Log Out'), array('controller' => 'users', 'action' => 'logout', 'Blogger','blogger'=>true)); ?></li>
                      </ul>
                    </div>
...
<!-- HEADER END -->
<?php }elseif(!empty($authCompponent) && $authCompponent['role_id'] == 6){?>
<!-- HEADER -->
<header class="header dark-header newHeader">
    <div class="container">
            <div class="row">
            ...
            <div class="col-xs-6 col-sm-7">
                <div class="right-frame">
                    ...
                    <div class="orange-icon dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="videoUploader/dashboard/myProfile"><?php echo __dbt('Profile');?></a></li>
                        <!--<li><?php //echo $this->Html->link(__dbt('Profile'), array('controller' => 'dashboard', 'action' => 'myProfile')); ?><li>-->
                        <li class="divider"></li>
                        <li><?php  echo $this->Html->link(__dbt('Log Out'), array('controller' => 'users', 'action' => 'logout', 'Blogger','blogger'=>true)); ?></li>
                      </ul>
