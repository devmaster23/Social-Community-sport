                ...
                <table border="0" class="table table-bordered table-striped" cellpadding="0" cellspacing="0">
                   ...
                   <?php  foreach ($dataExists as $dataExist)
                    ...
                    <tr> 
                       ...
                       <td><?php echo __dbt($dataExist['team']['name'].'&nbsp &nbsp '.$dataExist['FootballPrediction']['first_team_goals']).'&nbsp &nbsp<strong>V/S</strong>&nbsp &nbsp'. $dataExist['secondteam']['name'].'&nbsp &nbsp '.$dataExist['FootballPrediction']['second_team_goals']?></td>
