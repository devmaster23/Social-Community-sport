    ...
    <div class="container">
        ...
        <div class="profile-page-wrap">
            <div class="event-title">
                <h4><?php echo __dbt('Hockey Prediction'). ' - ' . $tournament_name;?></h4>
                     ...
                     <div class="col-sm-10"> 
                        <div class="profile-form-layout">
                           ...
                           // {
                            ...
                            echo $this->Form->create('HockeyPrediction', array('url' => array('controller' => 'Games', 'action' => 'hockeyPrediction'), "class" => "form-horizontal" )); 
                                            ...
                                            <tr>
                                               <td><?php echo $game_counter; ?> </td>
                                                <td><?php echo __dbt($gameData['First_team']['name']); ?> <?php
                                                 ...
                                                 echo $this->Form->input("HockeyPrediction.{$game_counter}.first_team_goals", array("type"=>"number","class"=>"form-control",'label' => false ,'min' =>'0')); 
                                                 }
                                                ...
                                                <?php
                                                if(!empty($gift_id) && empty($game_id)){
                                                 echo $this->Form->input("HockeyPrediction.{$game_counter}.second_team_goals", array("type"=>"number","class"=>"form-control",'label' => false ,'min' =>'0'));
                                                echo $this->Form->input("HockeyPrediction.{$game_counter}.gift_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => "$gift_id",'label' => false)); 
                                                echo $this->Form->input("HockeyPrediction.{$game_counter}.sport_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => 
                                                $gameData['Sport']['id'],'label' => false)); 
                                                echo $this->Form->input("HockeyPrediction.{$game_counter}.tournament_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => $gameData['Tournament']['id'],'label' => false));
                                                echo $this->Form->input("HockeyPrediction.{$game_counter}.league_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => $gameData['League']['id'],'label' => false));
                                                echo $this->Form->input("HockeyPrediction.{$game_counter}.user_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => $user_id,'label' => false));
                                                echo $this->Form->input("HockeyPrediction.{$game_counter}.game_day", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => $maxgameddays,'label' => false));
                                                echo $this->Form->input("HockeyPrediction.{$game_counter}.game_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" =>$gameData['Game']['id'],'label' => false));
                                                }
                                                ?></td>
...
<?php echo $this->Form->create(null, array('url' => '/games/hockeyScheduling','id' => 'myform1')); ?>
    ...
    $('.calcPrediction').click(function () {
      ...
      //  var firstTeam = Base64.encode($(this).attr("firstTeam"));
       // var secondTeam = Base64.encode($(this).attr("secondTeam"));
        ...
        $('.modal-body').load('/games/findHockeyPrediction/' + gameDay, function (result) {
       ...
       $('.setPrediction').click(function () {
        ...
        var controllerName='hockeyScheduling';
