         ...
         <div class="table-responsive">
                <table border="0" class="table table-bordered table" cellpadding="0" cellspacing="0">
                 <tr> 
                    ...
                    $giftname="Cash";
                    $giftvalue=$giftdata[0]['gift']['amount'].'(USD)-'.$giftdata[0]['GamesGiftPrediction']['cashamount'];
                ...
                <table border="0" class="table table-bordered table" cellpadding="0" cellspacing="0">
                   ...
                   <?php  foreach ($dataExists as $dataExist)
                    { //echo '<pre>';print_r($dataExist);?>
                      ...
                      <?php $predictedscore = $dataExist['BasketballPrediction']['first_team_goals'].'/'.$dataExist['BasketballPrediction']['second_team_goals'];
