			...
			<div class="box-body">	
			   <div class="row">
			     <?php  echo $this->Form->create('Game', array('type' => 'get', 'url' => array('controller' => 'games', 'action' => 'index', $this->params["prefix"] => true), "novalidate"=>"novalidate")); ?>
					    <?php echo "<div class='col-xs-2'>". $this->Form->input("Game.name", array("label"=>false, "placeholder"=>"Search by Name", "div"=>false,'class'=>"form-control"))."</div>"; ?>
					    <?php echo "<div class='col-xs-2'>". $this->Form->input("Game.team_id", array('name'=>'first_team',"label"=>false,"empty"=>"--Team First--", "div"=>false,'class'=>"form-control"))."</div>"; ?>
					    <?php echo "<div class='col-xs-2'>". $this->Form->input("Game.team_id", array('name'=>'second_team',"label"=>false,"empty"=>"--Team Second --", "div"=>false,'class'=>"form-control"))."</div>"; ?>
					    
					    
						<div class='col-xs-3 col-xs-offset-3 admin-search-btn'>
					...
					<tr>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink(__dbt(''), array('action' => 'delete', base64_encode($game['Game']['id'])),array('class'=>'fa fa-remove','title'=>'Delete Game'), array(__dbt('Are you sure you want to delete this game ?'))); ?>
                                ...
                                <?php endforeach; } else {  ?>
                                <tr>    
                                   <td class="text-center" colspan="7"><?php echo __dbt('No result found.'); ?>&nbsp;</td>
                                </tr>    
                                <?php } ?>          
				</tbody>
				</table>
