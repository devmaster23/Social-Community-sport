		...
		<div class="box box-primary">
			...
			<div class="box-body">
						...
						<div class="col-sm-4" id="league-box">
                                                        <?php echo $this->Form->input('league_id', array("class"=>"form-control",'label' => false,'empty'=>'-- Select League --',"onchange"=>"getTeams(this);"));  ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-4" id="team-box">
                                                  <?php echo $this->Form->input('first_team', array("type"=>"select", "value"=>"0",'empty' => '-- Select Team --',"class"=>"form-control",'label' => false,"onchange"=>"getTeamsFilter(this);"));?>
						...
						<div class="col-sm-4" id="team2-box">
                                                        ...
                                                        <?php   echo $this->Form->input('second_team', array("type"=>"select", "value"=>"0",'empty' => '-- Select Team --',"class"=>"form-control",'label' => false));?>
						...
						<div class="col-sm-4">
							...
							echo $this->Form->input('status', array("type"=>"select", "value"=>"1", "options"=>$status_options,"empty"=>"-- Select Status --","class"=>"form-control",'label' => false)); ?>
