  ...
  <div class="row">
	...
	<div class="box">
		<div class="box-header">
			...
			<div class="box-body">	
			   <div class="row">
			     <?php  echo $this->Form->create('BasketballPrediction', array('type' => 'get', 'url' => array('controller' => 'games', 'action' => 'basketballPredictions', $this->params["prefix"] => true), "novalidate"=>"novalidate")); ?>
                       ...
                       <?php echo "<div class='col-xs-2'>". $this->Form->input("BasketballPrediction.teams_gameday", array("label"=>false, "div"=>false,"placeholder"=>"Search by Game",'empty'=>'Select Day', 'options' => @$game,'class'=>"form-control"))."</div>"; ?>
		...
		<div class="box-body">
			<table id="example" class="table table-striped">
				...
				<tbody>
				<?php  if(!empty($basketballpredictionswinnerdata_array)) {
				    //print_r($soccerwinnerdata_array);
                                    foreach ($basketballpredictionswinnerdata_array as $soccers): 
					...
					<tr>
						...
						<td><?php echo h($soccer['BasketballPrediction']['game_day']); ?>&nbsp;</td>
						<td class="actions">
							<?php echo $this->Html->link(__dbt(''),  'javascript:void(0)',array('class'=>'fa fa-eye viewresult','title'=>'View Score','userId' 
						=>base64_encode($soccer['User']['id']),'gameDay' => base64_encode($soccer['BasketballPrediction']['game_day']))); ?>
