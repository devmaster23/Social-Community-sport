    ...
    <div class="container">
        ...
        <div class="profile-page-wrap">
            <div class="event-title">
                <h4><?php echo __dbt('Baseball Prediction'); ?></h4>
                            ...
                            <div class="table-responsive">
                                <table border="0" class="table table-hover table-bordered table-striped" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <th class="text-center" width="12%"><?php echo __dbt('Action'); ?></th>
                                    </tr>
                                    <?php
                                    if (!empty($gameDatas)) {
...
//                                                    }
                                                ...
                                                <td class="text-center action-link">
                                                    ...
                                                    <?php
                                                    $result = $this->Common->getPridictedOrNot($gameData['Game']['id'], $sport = 'baseball');
//                                            if($result==0){
//                                              if((date('Y-m-d H:i:s') >= $startPrediction) AND (date('Y-m-d H:i:s') <= $stopPrediction)) {  
...
<script>
    $('.calcPrediction').click(function () {
        ...
        $('.modal-body').load('/games/findBaseballPrediction/' + gameId + '/' + firstTeam + '/' + secondTeam, function (result) {
    ...
    $('.setPrediction').click(function () {
        ...
        $('.modal-body1').load('/games/baseballPrediction/' + gameId + '/' + leagueId + '/' + tournamentId + '/' + sportId, function (result) {
