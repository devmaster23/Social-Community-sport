<div class="space-15">
    <?php echo $this->Form->create('FootballPrediction', array('url' => array('controller' => 'Games', 'action' => 'footballPrediction'), "class" => "form-horizontal")); ?>
...
<script>
    $("#FootballPredictionFootballPredictionForm").validate({
        rules: {
            "data[FootballPrediction][first_team_goals]": {
                required: true,
                digits: true,
            },
            "data[FootballPrediction][second_team_goals]": {
                required: true,
                digits: true,
            }
        },
