<div class="space-15">
    <?php echo $this->Form->create('BasketballPrediction', array('url' => array('controller' => 'Games', 'action' => 'basketballPrediction'), "class" => "form-horizontal")); ?>
...
<script>
    $("#BasketballPredictionBasketballPredictionForm").validate({
        rules: {
            "data[BasketballPrediction][first_team_goals]": {
                required: true,
                digits: true,
            },
            "data[BasketballPrediction][second_team_goals]": {
                required: true,
                digits: true,
            }
        },
