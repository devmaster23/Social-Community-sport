    ...
    <div class="container">
        ...
        <div class="profile-page-wrap">
            <div class="event-title">
                <h4><?php echo __dbt('Soccer Prediction') . ' - ' . $tournament_name; ?></h4>
                    ...
                    <div class="col-sm-10">
                        <div class="profile-form-layout">
                           ...
                           // {
                            ...
                            echo $this->Form->create('SoccerPrediction', array('url' => array('controller' => 'Games', 'action' => 'soccerPrediction'), "class" => "form-horizontal" )); 

                            ?>
                                <table style="border:0px solid black" class="table table-hover table-bordered table-striped" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <th><?php echo __dbt('# Game'); ?></th>
                                        
                                        <th><?php 
                                        echo $this->Paginator->sort('First_team.name',__dbt('First Team')); ?></th>
                                        <th><?php 
                                        echo $this->Paginator->sort('Second_team.name',__dbt('Second Team')); ?></th>
                                   ...
                                   if (!empty($gameDatas)) 
                                    {
                                        ...
                                        foreach ($gameDatas as $gameData)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo __dbt($gameData['First_team']['name']); ?> 
                                                 
                                                 <?php
                                                 if(!empty($gift_id) &&  empty($game_id)){ 
                                                 echo $this->Form->input("SoccerPrediction.{$game_counter}.first_team_goals", array("type"=>"number","class"=>"form-control",'label' => false ,'min' =>'0')); 
                                                 }
                                                ...
                                                <?php
                                                if(!empty($gift_id) && empty($game_id)){
                                                 echo $this->Form->input("SoccerPrediction.{$game_counter}.second_team_goals", array("type"=>"number","class"=>"form-control",'label' => false ,'min' =>'0'));
                                                echo $this->Form->input("SoccerPrediction.{$game_counter}.gift_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => "$gift_id",'label' => false)); 
                                                echo $this->Form->input("SoccerPrediction.{$game_counter}.sport_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => 
                                                $gameData['Sport']['id'],'label' => false)); 
                                                echo $this->Form->input("SoccerPrediction.{$game_counter}.tournament_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => $gameData['Tournament']['id'],'label' => false));
                                                echo $this->Form->input("SoccerPrediction.{$game_counter}.league_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => $gameData['League']['id'],'label' => false));
                                                echo $this->Form->input("SoccerPrediction.{$game_counter}.user_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => $user_id,'label' => false));
                                                echo $this->Form->input("SoccerPrediction.{$game_counter}.game_day", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" => $maxgameddays,'label' => false));
                                                echo $this->Form->input("SoccerPrediction.{$game_counter}.game_id", array("type"=>"hidden",'data-field'=>'datetime',"class"=>"form-control","value" =>$gameData['Game']['id'],'label' => false));
                                                }
                                                ?> </td>
                                ...
                                <?php echo $this->Form->submit(__dbt('Submit'),array('type' => 'submit','onclick' => 'confirm()','class'=>'btn btn-primary','id' => 'confirmationbutton','div'=>false)); 
...
<?php echo $this->Form->create(null, array('url' => '/games/soccerScheduling','id' => 'myform1')); ?>
...
<script>
    $('.calcPrediction').click(function () {
      ...
      //  var firstTeam = Base64.encode($(this).attr("firstTeam"));
       // var secondTeam = Base64.encode($(this).attr("secondTeam"));
        ...
        $('.modal-body').load('/games/findSoccerPrediction/' + gameDay, function (result) {
    ...
    $('.setPrediction').click(function () {
        ...
        var controllerName='soccerScheduling';
