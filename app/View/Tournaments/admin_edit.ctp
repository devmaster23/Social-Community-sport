<section class="content-header">
	<h1><?php echo __dbt('Tournament'); ?>
	  <small><?php echo __dbt('Edit Tournament'); ?></small>
	</h1>
			...
			<div class="box-body">
				<?php echo $this->Form->create('Tournament',array('class'=>'form-horizontal', "enctype"=>"multipart/form-data")); ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<?php echo $this->Form->input('sport_id', array("class"=>"form-control",'label' => false));  ?>
						</div>
					</div>
                                        <?php /*
					<div class="form-group">
					...
					<div class="box-footer">
						...
						<a class="btn btn-warning margin" href="/admin/tournaments"><?php echo __dbt('Cancel'); ?></a>
                                                </div>
					</div>
