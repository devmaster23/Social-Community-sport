		...
		<div class="box">
			<div class="box-header">
			  <h3 class="box-title"><?php echo __dbt('Users Details'); ?></h3>
                           <a href="/admin/news" class="btn btn-warning pull-right"><?php echo __dbt('Back'); ?></a>
			</div>
				...
				<table class="table table-striped">
					<tbody>
						...
						<tr>
                          ...
                          <tr>
						  <td><?php echo __dbt('External URL'); ?></td>
						  <td><?php echo strip_tags($news['News']['external_url']); ?></td>
						</tr>
						<tr>
						  <td><?php echo __dbt('News Image'); ?></td>
						  <td><?php echo $this->Html->image($news['File']['path'],array('style'=>'width:30%'));?></td>
						</tr>
						<?php if(!empty($news['SecondFile']['path'])){?>
						<tr>
						  <td><?php echo __dbt('Second Image'); ?></td>
						  <td><?php echo $this->Html->image($news['SecondFile']['path'],array('style'=>'width:30%'));?></td>
						</tr>
						<?php }?>
						<tr>
