            ...
            <div class="inner-wrap">
               ...
               <?php echo $this->element($elementFolder.'/sidebar'); ?>
                    ...
                    <div class="col-sm-10">
                            ...
                            <div class="inn-title">
                <h2><i class="fa fa-check" aria-hidden="true"></i><?php $teamName = AuthComponent::User('sportSession.teamName'); echo  !empty($teamName) ? $teamName .' '.__dbt('Team')  : __dbt('My Teams'); ?></h2>
            </div>
