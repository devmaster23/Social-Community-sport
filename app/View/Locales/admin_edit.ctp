...
<?php echo $this->Form->create('Locale'); ?>
	<fieldset>
		<legend><?php echo __dbt('Admin Edit Locale'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__dbt('Delete'), array('action' => 'delete', $this->Form->value('Locale.id')), array('confirm' => __dbt('Are you sure you want to delete # %s?', $this->Form->value('Locale.id')))); ?></li>
