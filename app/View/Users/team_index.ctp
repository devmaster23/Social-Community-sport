		...
		<div class="box-body">
			<table id="example2" class="table table-striped">
				...
				<tr>
					...
					<td><?php echo $this->Html->link($user['Role']['name'], array('controller' => 'roles', 'action' => 'view', $user['User']['role_id'])); ?></td>
					<td><?php echo $this->Html->link($user['Locale']['name'], array('controller' => 'locales', 'action' => 'view', $user['User']['locale_id'])); ?></td>
