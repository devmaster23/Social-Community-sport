    ...
    <div class="login-page-layout">
        <div class="container-fluid">
            <div class="row">
            	...
            	<h2 class="box-title"><span><?php echo __dbt('Sign In'); ?></span></h2>
                ...
                <div class="col-xs-12" style="border-bottom:1px solid #ccc;">
                    ...
                    <div class="form-field">
                        <?php echo $this->Form->input('remember_me',array('class'=>'form-control','type'=>'checkbox','checked'=>!empty($_COOKIE['email']) ? true : false));  ?>
