...
<section class="content-header">
  <h1>
    ...
    <small><?php echo __dbt('Deleted Users'); ?></small>
  </h1>
  ...
  <div class="row">
	...
	<div class="box">
		...
		<div class="UserAdminIndexForm">
			<div class="box-body">	
			   <div class="row">
			     <?php echo $this->Form->create('User', array('type' => 'get', 'url' => array('controller' => 'users', 'action' => 'deleted', $this->params["prefix"] => true,'class'=>"form-control"), "novalidate"=>"novalidate")); ?>
		...
		<div class="box-body">
			<table id="example2" class="table table-striped">
				...
				<tr>
					...
					<td> <?php echo $this->Form->postLink(__dbt(''), array('action' => 'delstatus', base64_encode($user['User']['id']),base64_encode(1)), array('class'=>'fa fa-user-plus activate-icon','title'=>'Activate User'),array(__dbt('Are you sure you want to activate this user?'))); ?></td>
				</tr>
                                 <?php  endforeach; ?>
				</tbody>
			</table>
