<section class="content-header">
	<h1><?php echo __dbt('Edit User'); ?>
	  <small><?php echo __dbt('Sports Edit User'); ?></small>
	</h1>
			...
			<div class="box-body">
				...
				<?php echo $this->Form->create('User', array("novalidate"=>"novalidate","class"=>"form-horizontal", "enctype"=>"multipart/form-data"));
					...
					<div class="form-group">
						...
						echo $this->Form->input('status', array("type"=>"select",'class'=>'form-control','label' => false, "options"=>$status_options,'empty'=>'-- Select Options --')); ?>
						</div>
					</div>	
					<div class="box-footer">
						<div class="col-sm-4 control-label">
						<?php echo $this->Form->submit('Submit',array('type' => 'submit','class'=>'btn btn-primary','div'=>false)); ?>
						<a class="btn btn-warning margin" href="/sports/users"><?php echo __dbt('Cancel'); ?></a>
                                                </div>
					</div>
			</div>
		</div>
