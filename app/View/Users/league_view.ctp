<section class="content-header">
	<h1><?php echo __dbt('View User'); ?>
	  <small><?php echo __dbt('View Details'); ?></small>
	</h1>
	  ...
	  <div class="col-md-12">
		<div class="box">
			<div class="box-header">
			  <h3 class="box-title"><?php echo __dbt('View Details'); ?></h3>
                          <a href="/league/users" class="btn btn-warning pull-right"><?php echo __dbt('Back'); ?></a>
			</div>
			<div class="box-body no-padding">
				<table class="table table-striped">
						...
						<tr>
						  ...
						  <td><?php if($user['File']['name']){echo $this->Html->image(BASE_URL.'img/ProfileImages/large/'.$user['File']['new_name']);}else{echo $this->Html->image(DEFAULT_PROFILE_IMG,array('style'=>'width:30%'));} ?></td>
						</tr>
						<tr>
