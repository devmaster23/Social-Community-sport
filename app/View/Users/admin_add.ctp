<section class="content-header">
	<h1><?php echo __dbt('Add User'); ?>
	  <small><?php echo __dbt('Admin Add User'); ?></small>
	</h1>
		...
		<div class="box box-primary">
				...
				<?php echo $this->Form->create('User',array('class'=>'form-horizontal', 'autocomplete'=>"off", "enctype"=>"multipart/form-data")); ?>
					<div class="form-group">
						...
						<div class="col-sm-4">
						<?php echo $this->Form->input('name',array('class'=>'form-control','placeholder'=>'Enter your name','label' => false, 'autocomplete'=>"off")); ?>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						<?php echo $this->Form->input('email',array('class'=>'form-control','placeholder'=>'Enter your email','label' => false, 'autocomplete'=>"off", 'value'=>'')); ?>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						<?php echo $this->Form->input('password',array('type'=>'password','class'=>'form-control','label' => false, 'autocomplete'=>"off", 'value'=>'')); ?>
						</div>
					</div>
...
<div class="form-group">
					...
					<div class="box-footer">
						...
						<a class="btn btn-warning margin" href="/admin/users"><?php echo __dbt('Cancel'); ?></a>
                                                </div>
					</div>
			        </div>
		</div>
