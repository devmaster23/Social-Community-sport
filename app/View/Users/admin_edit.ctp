<section class="content-header">
	<h1><?php echo __dbt('Edit User'); ?>
	  <small><?php echo __dbt('Admin Edit User'); ?></small>
	</h1>
		...
		<div class="box box-primary">
				...
				<?php echo $this->Form->create('User',array('class'=>'form-horizontal', "novalidate"=>"novalidate", "enctype"=>"multipart/form-data")); ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
						<?php echo $this->Form->input('email',array('class'=>'form-control','placeholder'=>'Enter your email','label' => false,'readonly'=>true)); ?>
						</div>
					</div>
					<div class="form-group">
