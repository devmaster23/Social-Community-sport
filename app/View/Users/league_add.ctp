<section class="content-header">
	<h1><?php echo __dbt('Add User'); ?>
	  <small><?php echo __dbt('League Admin Add User'); ?></small>
	</h1>
	...
	<div class="row">
	  <div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">
				<?php echo $this->Form->create('User',array('class'=>'form-horizontal','novalidate', "enctype"=>"multipart/form-data")); ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
					<?php echo $this->Form->input('locale_id',array('class'=>'form-control','label' => false,'empty'=>'-- Select Role --')); ?>
					</div>
				</div>
				<div class="form-group">
